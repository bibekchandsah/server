...
```bash
PS D:\server> python file_server.py
...
🎨 UI Style:             Professional with file details

📁 DIRECTORY CONFIGURATION:
Enter directory path to share: D:\github\repository\all-documentsss\compressed size=2472 x 3684
✅ Selected directory: D:\github\repository\all-documentsss\compressed size=2472 x 3684

🌐 PORT CONFIGURATION:
Enter port number (default: 8000): 8000
✅ Selected port: 8000

✅ Found 15 files in directory
...
💡 SHARING TIPS:
   ...
   • For internet sharing, use ngrok, Cloudflare Tunnel, or Serveo

⚡ PERFORMANCE:
   • Speed: MAXIMUM (8MB chunks)
   • Multi-user: Enabled (Threading)
   • Resume: Enabled (HTTP Range Requests)
